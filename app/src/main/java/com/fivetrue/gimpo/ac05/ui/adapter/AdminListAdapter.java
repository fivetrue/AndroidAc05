...
public class AdminListAdapter extends BaseRecyclerAdapter<AdminActivity.IAdminItem, AdminListAdapter.AdminViewHolder> {


    public AdminListAdapter(List<AdminActivity.IAdminItem> data) {
