...
public class GalleryActivity extends BaseActivity {
    ...
    private void initData(){
        ...
        mAdapter = new GalleryListAdapter(mGalleryMessageDatabase.getGalleryMessage(), getCurrentFragmentManager(), mConfigPref.getUserInfo());
    ...
    private void initView(){
        ...
        if(mAdapter.getCount() > 0){
            ImageLoadManager.getInstance().loadImageUrl(mConfigPref.getAppConfig().defaultImageUrl, new ImageLoader.ImageListener() {
                @Override
        ...
        mUploadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FirebaseStorageManager.chooseDeviceImage(GalleryActivity.this, REQUEST_IMAGE_PICKER);
            }
        });
    }

    private void cropImage(Uri uri) {
        FirebaseStorageManager.cropChooseDeviceImage(this, uri, 1, 1, 1080, 1080);
    }
